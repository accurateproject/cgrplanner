...
#########################################################################
TPlan = db.define_table('tplan',
                           Field('name'),
                           auth.signature,
)

Timings = db.define_table('timing',
...
Destinations = db.define_table('destination',
                            Field('tpid', 'reference tplan', readable=False, writable=False),
                            Field('tag', unique=False),
                            Field('dest_prefix'),
                            auth.signature,
...
DestinationRates = db.define_table('destination_rate',
                                   Field('tpid', 'reference tplan', readable=False, writable=False),
                                   Field('tag', unique=False),
...
RatingPlans = db.define_table('rating_plan',
                              Field('tpid', 'reference tplan', readable=False, writable=False),
                              Field('tag', unique=False),
...
ActionTriggers = db.define_table('action_trigger',
                                 Field('tpid', 'reference tplan', readable=False, writable=False),
                                 Field('tag', unique=False),
                                 Field('balance_type'),
                                 Field('direction'),
...
AccountActions = db.define_table('account_actions',
                                 Field('tpid', 'reference tplan', readable=False, writable=False),
                                 Field('loadid', readable=False, writable=False),
                                 Field('tenant'),
                                 Field('account'),
